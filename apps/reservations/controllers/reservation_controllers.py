...
from apps.reservations.serializers import (ReservationSerializer,ReservationUpdateSerializer,)
...
@extend_schema_view(get=host_reservations_schema,)
class HostReservationsAPIView(BaseReservationAPIView, generics.ListAPIView):
    ...
    def get_queryset(self) -> QuerySet[Reservation]:
        ...
        return (Reservation.objects.filter
                        (listing__user=self.request.user).select_related
                        ("listing", "user").order_by("-created_at"))
...
class ReservationCancelAPIView(BaseReservationAPIView,generics.GenericAPIView,):
    ...
    def get_queryset(self) -> QuerySet[Reservation]:
        ...
        return Reservation.objects.select_related("listing", "user", "listing__user")
    ...
    def post(self,request: Request,*args: Any,**kwargs: Any,) -> Response:
        ...
        if not service.cancel_reservation(reservation, request.user):
            return Response(
