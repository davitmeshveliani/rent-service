...
class ListingCRUDTests(APITestCase):
    ...
    def test_update_listing_owner(self):
        ...
        self.assertEqual(self.listing.title,"Updated Berlin Flat",)
    ...
    def test_average_rating_default_value(self):
            """
            Verify that a new listing starts with an average rating of 0.
            """
